...
/// Initialize a new group member pointer.
///
/// ### Accounts:
...
impl InitializeGroupMemberPointer<'_> {
    ...
    pub fn invoke_signed(&self, signers: &[Signer]) -> ProgramResult {
        const GROUP_MEMBER_POINTER_DISCRIMINATOR: u8 = 0x29;
        const GROUP_MEMBER_POINTER_INITIALIZE_DISCRIMINATOR: u8 = 0x00;
        ...
        write_bytes(
            ...
            &[GROUP_MEMBER_POINTER_INITIALIZE_DISCRIMINATOR],
        );
        ...
        write_bytes(
            &mut instruction_data[Self::MEMBER_ADDRESS_OFFSET..],
            self.member_address,
        );
